...
cursor.execute("""
    ...
    VALUES ('2024-09-24 06:45', '2024-09-24 06:42', 'SCH2024092401', 10, 'S2409202410', 15, 'NA001310', 'E250Br', 5.012, 2008, 18, 5.0, 2000, 'A',0) -- good quality
""")
...
cursor.execute("""
    INSERT INTO RESULT (DATEE, DATESE, SCHNO, SEQ, SLAB, S_WEIGHT, COIL, STCOD, CTHICK, CWIDTH, AWEIT, OTHICK, OWIDTH, SHIFT,STIME)
    VALUES ('2024-09-24 12:45', '2024-09-24 12:41', 'SCH2024092403', 30, 'S2409202418', 32, 'NA001312', 'API X', 7.008, 1605, 21, 7.0, 1600, 'A',11) -- good quality
""")

cursor.execute("""
    INSERT INTO RESULT (DATEE, DATESE, SCHNO, SEQ, SLAB, S_WEIGHT, COIL, STCOD, CTHICK, CWIDTH, AWEIT, OTHICK, OWIDTH, SHIFT,STIME)
    VALUES ('2024-09-24 18:20', '2024-09-24 18:17', 'SCH2024092404', 40, 'S2409202420', 18, 'NA001313', 'CRGO', 8.015, 1528, 22, 8.0, 1500, 'B',0) -- bad quality (CWIDTH > +13)
""")
...
cursor.execute("""
    INSERT INTO RESULT (DATEE, DATESE, SCHNO, SEQ, SLAB, S_WEIGHT, COIL, STCOD, CTHICK, CWIDTH, AWEIT, OTHICK, OWIDTH, SHIFT,STIME)
    VALUES ('2024-09-25 07:00', '2024-09-25 06:57', 'SCH2024092501', 10, 'S2509202410', 16, 'NA001314', 'E250Br', 5.005, 2005, 17.5, 5.0, 2000, 'A',0) -- good quality
""")
...
cursor.execute("""
    INSERT INTO RESULT (DATEE, DATESE, SCHNO, SEQ, SLAB, S_WEIGHT, COIL, STCOD, CTHICK, CWIDTH, AWEIT, OTHICK, OWIDTH, SHIFT,STIME)
    VALUES ('2024-09-25 14:40', '2024-09-25 14:37', 'SCH2024092503', 30, 'S2509202418', 31, 'NA001316', 'API X', 7.005, 1608, 22, 7.0, 1600, 'B',0) -- good quality
""")

cursor.execute("""
    INSERT INTO RESULT (DATEE, DATESE, SCHNO, SEQ, SLAB, S_WEIGHT, COIL, STCOD, CTHICK, CWIDTH, AWEIT, OTHICK, OWIDTH, SHIFT,STIME)
    VALUES ('2024-09-25 15:00', '2024-09-25 14:56', 'SCH2024092504', 40, 'S2509202420', 20, 'NA001317', 'CRGO', 8.030, 1510, 23, 8.0, 1500, 'B',16) -- bad quality (CTHICK > 0.013)
""")
...
cursor.execute(""" 
    INSERT INTO RESULT (DATEE, DATESE, SCHNO, SEQ, SLAB, S_WEIGHT, COIL, STCOD, CTHICK, CWIDTH, AWEIT, OTHICK, OWIDTH, SHIFT, STIME)
    VALUES ('2024-09-26 18:45', '2024-09-26 18:42', 'SCH2024092604', 40, 'S2609202418', 25, 'NA001321', 'API X', 9.020, 1415, 26, 9.0, 1400, 'C',0) -- bad quality (CWIDTH > +13)
""")
...
cursor.execute(""" 
    INSERT INTO RESULT (DATEE, DATESE, SCHNO, SEQ, SLAB, S_WEIGHT, COIL, STCOD, CTHICK, CWIDTH, AWEIT, OTHICK, OWIDTH, SHIFT,STIME)
    VALUES ('2024-09-27 10:50', '2024-09-27 10:47', 'SCH2024092703', 30, 'S2709202403', 30, 'NA001324', 'API Y', 6.010, 1700, 23, 6.0, 1705, 'B',17) 
""")

cursor.execute(""" 
    INSERT INTO RESULT (DATEE, DATESE, SCHNO, SEQ, SLAB, S_WEIGHT, COIL, STCOD, CTHICK, CWIDTH, AWEIT, OTHICK, OWIDTH, SHIFT,STIME)
    VALUES ('2024-09-27 15:00', '2024-09-27 14:57', 'SCH2024092704', 40, 'S2709202404', 31, 'NA001325', 'CRGO', 6.030, 1950, 22, 5.970, 1950, 'B',0) 
""")

# -- 2024-09-28 
cursor.execute(""" 
    INSERT INTO RESULT (DATEE, DATESE, SCHNO, SEQ, SLAB, S_WEIGHT, COIL, STCOD, CTHICK, CWIDTH, AWEIT, OTHICK, OWIDTH, SHIFT,STIME)
    VALUES ('2024-09-28 05:00', '2024-09-28 04:57', 'SCH2024092705', 40, 'S2709202439', 31, 'NA001399', 'CRGO', 6.030, 1950, 22, 5.970, 1950, 'C',0) 
""")
...
cursor.execute(""" 
    INSERT INTO RESULT (DATEE, DATESE, SCHNO, SEQ, SLAB, S_WEIGHT, COIL, STCOD, CTHICK, CWIDTH, AWEIT, OTHICK, OWIDTH, SHIFT,STIME)
    VALUES ('2024-09-28 10:40', '2024-09-28 10:36', 'SCH2024092803', 3, 'S2809202412', 32, 'NA001703', 'E250Br', 5.980, 2000, 26, 6.0, 2000, 'A',11)  -- Bad Quality (CTHICK out of range)
""")
...
cursor.execute(""" 
    INSERT INTO RESULT (DATEE, DATESE, SCHNO, SEQ, SLAB, S_WEIGHT, COIL, STCOD, CTHICK, CWIDTH, AWEIT, OTHICK, OWIDTH, SHIFT,STIME)
    VALUES ('2024-09-29 12:20', '2024-09-29 12:17', 'SCH2024092903', 7, 'S2909202416', 32, 'NA001707', 'E350Br', 5.975, 2000, 26, 6.0, 2000, 'A',17)  -- Bad Quality (CTHICK out of range)
""")
cursor.execute(""" 
    INSERT INTO RESULT (DATEE, DATESE, SCHNO, SEQ, SLAB, S_WEIGHT, COIL, STCOD, CTHICK, CWIDTH, AWEIT, OTHICK, OWIDTH, SHIFT,STIME)
    VALUES ('2024-09-30 02:00', '2024-09-30 01:57', 'SCH2024092904', 8, 'S2909202417', 31, 'NA001708', 'E350Br', 6.006, 2011, 25.5, 6.0, 2000, 'C',0) 
""")
...
cursor.execute(""" 
    INSERT INTO RESULT (DATEE, DATESE, SCHNO, SEQ, SLAB, S_WEIGHT, COIL, STCOD, CTHICK, CWIDTH, AWEIT, OTHICK, OWIDTH, SHIFT,STIME)
    VALUES ('2024-09-30 04:00', '2024-09-30 03:56', 'SCH2024092934', 8, 'S2909202467', 34, 'NA001718', 'E250Br', 6.062, 2008, 27.5, 6.0, 1960, 'C',0) 
""")
cursor.execute(""" 
    INSERT INTO RESULT (DATEE, DATESE, SCHNO, SEQ, SLAB, S_WEIGHT, COIL, STCOD, CTHICK, CWIDTH, AWEIT, OTHICK, OWIDTH, SHIFT,STIME)
...
cursor.execute(""" 
    INSERT INTO RESULT (DATEE, DATESE, SCHNO, SEQ, SLAB, S_WEIGHT, COIL, STCOD, CTHICK, CWIDTH, AWEIT, OTHICK, OWIDTH, SHIFT,STIME)
    VALUES ('2024-09-30 23:20', '2024-09-30 23:17', 'SCH2024093003', 11, 'S3009202420', 32, 'NA001791', 'API X', 5.970, 1985, 26, 6.0, 2000, 'C',0)  -- Bad Quality (CWIDTH out of range)
""")
cursor.execute(""" 
    INSERT INTO RESULT (DATEE, DATESE, SCHNO, SEQ, SLAB, S_WEIGHT, COIL, STCOD, CTHICK, CWIDTH, AWEIT, OTHICK, OWIDTH, SHIFT,STIME)
    VALUES ('2024-10-01 01:40', '2024-10-01 01:37', 'SCH2024093004', 12, 'S3009202421', 31, 'NA001792', 'API X', 6.005, 2007, 25.5, 6.0, 2000, 'C',0) 
""")
